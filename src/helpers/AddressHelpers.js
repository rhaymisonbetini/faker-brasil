...
class AddressHelpers {
   ...
   * @returns object
   */
    static getCityAndStateByLocation(location) {
        return this.arrayCityAndState().find(cep => cep.sigla === location)
    }
    ...
    static initialName() {
        return [
            'Avenida', 'Rua', 'Viela', 'Passarela', 'Trecho', 'Alameda', 'Corredor', 'Marginal'
        ]
    }

    /**
    * return complements for address
    * @returns {array<string>}  
    */
    static complements() {
        return [
            'Proximo a padaria',
            'Na rua da escola',
            'Proximo a igreja catolica',
            'Em frente a rotatória',
            'Trecho',
            'Ao lado do Super mercado',
            'Na rua dos taxistas',
            'Proximo a farmácia',
            'Proximo ao material de construcao',
    ...
    static streetAndneighborhood() {
        return [
            ...
            "Doutor Enéas Carvalho de Aguiar",
            ...
            "Doutor João Guimarães",
            "João XXIII",
            "das Juntas Provisórias",
